...
namespace FreeSpeakWeb.Migrations
{
    ...
    [Migration("20260407185656_AddFriendIdPerformanceIndexes")]
    partial class AddFriendIdPerformanceIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeSpeakWeb.Data.GroupContentReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreeSpeakWeb.Data.GroupPost", b =>
                {
                    ...
                    b.HasIndex("Status", "GroupId", "CreatedAt")
            ...
            modelBuilder.Entity("FreeSpeakWeb.Data.GroupContentReport", b =>
                {
                    ...
                    b.HasOne("FreeSpeakWeb.Data.ApplicationUser", "Reporter")
                        .WithMany()
                        .HasForeignKey("ReporterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FreeSpeakWeb.Data.ApplicationUser", "Reviewer")
                        .WithMany()
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("FreeSpeakWeb.Data.GroupRule", "ViolatedRule")
                        .WithMany()
                        .HasForeignKey("ViolatedRuleId")
                        .OnDelete(DeleteBehavior.SetNull);
